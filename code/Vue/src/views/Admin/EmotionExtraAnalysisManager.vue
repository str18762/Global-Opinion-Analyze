...
export default {
    data() {
        return {
            ...
            general:'',
            name:'',
            selectedExtraEmotion: [],
        };
    },
    mounted() {
        this.extraEmotionList();
    },
    methods: {
        onSizeChange(size) {
            this.pageSize = size
        ...
        handleSelectionChange(extraEmotions) {
            this.selectedExtraEmotion = extraEmotions
        },
        handleDelete(extraEmotion) {
            this.$confirm('你确认要删除该条情感吗?', '温馨提示', {
                ...
                if (extraEmotion) {
                    ...
                    if(this.selectedExtraEmotion.length==0){
        ...
        async extraEmotionList() {
            ...
            this.$request.get("/admin/listExtraEmotion", { params: params }).then(res => {
                ...
                if (res.code === '200') {
                    ...
                    this.extraEmotions = res.data.items;
                } else {
                    this.$message.error(res.msg);
                }
            })
    ...
    <el-card class="page-container">
        ...
        <el-form inline>
            ...
            <el-form-item label="情感极性：">
                <el-input prefix-icon="el-icon-search" placeholder="请输入极性" v-model="general"></el-input>
            </el-form-item>
            <el-form-item>
                <el-button type="primary" @click="extraEmotionList">搜索</el-button>
                <el-button @click="name = '';general='' ">重置</el-button>
            </el-form-item>
        </el-form>
        <!-- 情感列表 -->
        <el-table :data="extraEmotions" style="width: 100%" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="情感极性" property="generalEmotion"></el-table-column>
