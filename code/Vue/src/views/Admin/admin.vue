<template>
  <el-row>
    <el-col :span="isCollapsed ? 1 : 3" style="height: 100vh !important;" class="aoe">
    ...
    <el-col :span="isCollapsed ? 23 : 21" style="height: 100vh !important;background-color: rgb(242, 242, 242);" class="aoeiuv">
...
.aoeiuv:after{
  opacity: 0.6;
  background-color: rgba(255, 255, 255, 200); /* 使用半透明的白色 */
}
</style>